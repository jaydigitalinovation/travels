        ...
        <div class="mt-5">
            ...
            <div class="detail">
            	@if(session()->has('error'))
					    ...
					    @endif
                <div class="form">      
                  <form enctype="multipart/form-data" method="post" action="{{url('/admin/store_add_info_package')}}">  
                  	...
                  	@csrf
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="country" name="country" value="" required="">
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <select name="package">
                                    ...
                                    <option value="{{$a->id}}">{{$a->package}}</option>
                                    @endforeach
                                  </select>
                                  @if($errors->has('country')) <p class="error_mes">{{ $errors->first('country') }}</p> @endif
                              </div>   
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="duration" name="duration" value="" required="">
