  ...
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
              ...
              @endif
                <div class="form">      
                  <form enctype="multipart/form-data" method="post" action="{{url('/admin/store_update_aboutus_about_data')}}/{{$id}}">  
                  	...
                  	@csrf
                          <div class="part">
                              ...
                              <div class="col-md-12">
                                 <input type="file" name="image1" onchange="readURL1(this);" value="">
                                 <img id="blah1" src="/uploads/{{$image1}}" width="100px" height="100px" alt="">
                                 @if($errors->has('image1')) <p class="error_mes">{{ $errors->first('image1') }}</p> @endif
                                 <input type="hiddden" name="oldimage1" value="{{$image1}}">
                               </div>   
                          </div>
                          <div class="part">
                              <div class="col-md-12 label">
