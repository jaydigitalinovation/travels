  ...
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
              ...
              @endif
                <div class="form">      
                  <form enctype="multipart/form-data" method="post" action="{{url('/admin/store_update_package_data')}}/{{$id}}">  
                  	...
                  	@csrf
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="duration" name="duration" value="{{$duration}}" required="">
